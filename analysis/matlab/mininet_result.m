...
minRTT_average_bitrate = readmatrix('Z:\Documents\code\ProjectVictoria\player.py\result\mininet_context_0429\minRTT-average-bitrate.csv');
minRTT_rebuffering = readmatrix('Z:\Documents\code\ProjectVictoria\player.py\result\mininet_context_0429\minRTT-rebuffering-count.csv');
RR_average_bitrate = readmatrix('Z:\Documents\code\ProjectVictoria\player.py\result\mininet_context_0429\RR-average-bitrate.csv');
RR_rebuffering = readmatrix('Z:\Documents\code\ProjectVictoria\player.py\result\mininet_context_0429\RR-rebuffering-count.csv');
...
for i = 1:length(lints_alpha_arr)
    for j = 1:length(linucb_alpha_arr)
        ...
        % average bitrate
        ts_average_bitrate = readmatrix(sprintf("Z:\Documents\code\ProjectVictoria\player.py\result\mininet_context_0429\LinTS-%.1f-average-bitrate.csv", lints_alpha));
        ucb_average_bitrate = readmatrix(sprintf("Z:\Documents\code\ProjectVictoria\player.py\result\mininet_context_0429\LinUCB-%.1f-average-bitrate.csv", linucb_alpha));
        ...
        % rebuffering
        ts_rebuffering = readmatrix(sprintf("Z:\Documents\code\ProjectVictoria\player.py\result\mininet_context_0429\LinTS-%.1f-rebuffering-count.csv", lints_alpha));
        ucb_rebuffering = readmatrix(sprintf("Z:\Documents\code\ProjectVictoria\player.py\result\mininet_context_0429\LinUCB-%.1f-rebuffering-count.csv", linucb_alpha));
