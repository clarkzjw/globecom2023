...
if '__main__' == __name__:
    ...
    h2.cmd("ifconfig h2-eth2 10.0.4.2 netmask 255.255.255.0")
    ...
    h2.cmd("ip rule add from 10.0.4.2 table 3")
    ...
    h2.cmd("ip route add 10.0.4.0/24 dev h2-eth2 scope link table 3")
    h2.cmd("ip route add 10.0.1.0/24 dev h2-eth2 scope link table 3")
