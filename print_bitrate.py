    ...
    for r in resolutions:
        ...
        for crf in range(crf_map[r][0], crf_map[r][1], crf_map[r][2]):
            ...
            for profile in ffmpeg_profiles:
                ...
                # cmd = "ffmpeg -i {input} {codec} -crf {crf} -profile:v {profile} -r {fps} -s {hw} {output_filename}". \
                #     format(input=raw, codec=codec, crf=crf, profile=profile, fps=fps, hw=hw, resolution=r,
